...
import smkcpanel.allauth.app_settings
from smkcpanel.allauth.account.models import EmailAddress
from smkcpanel.allauth.account.utils import get_next_redirect_url, setup_user_email
from smkcpanel.allauth.utils import (get_user_model, serialize_instance,
...
class SocialAccount(models.Model):
    user = models.ForeignKey(smkcpanel.allauth.app_settings.USER_MODEL)
    provider = models.CharField(max_length=30,
                                choices=providers.registry.as_choices())
